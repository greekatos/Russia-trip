...
export const trip: Trip = {
  ...
  quests: [
    ...
    {
      id: "return-athens",
      title: "Return ticket — Beijing → Athens",
      detail:
        "Return flight from China to Athens, Greece is not booked yet (Dimos + Antonios).",
      icon: "ticket",
      status: "open",
    },
  ],
  days: [
    ...
    },
    {
      ...
      city: "Beijing",
      country: "China",
      title: "Beijing — beds + exit TBD",
      summary:
        "Boys on the ground in Beijing. Housing not booked. Return to Athens not booked. Girls’ Greece exit still a mystery.",
      whereWeAre: "Beijing · Dimos + Antonios · housing PENDING",
      status: "planned",
      crewIds: ["dimo", "antonios"],
      notes: [
        "PENDING: where to stay in Beijing.",
        "PENDING: return flight from China to Athens.",
        "Nadia + Giota: still deciding when they leave for Greece.",
      ],
      todos: [
        "PENDING: book Beijing stay",
        "PENDING: book China → Athens return",
      ],
    },
  ],
};
